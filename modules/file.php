...
class module{
	...
	public function content(){
		...
		//$this->core->notify("Доступ запрещен!", "Для доступа к профилю необходима авторизация", 1, "page/403");
		...
		if(!$update){ $this->core->notify($this->core->lng['e_msg'], $this->core->lng['e_sql_critical'], 1, "page/403"); }
